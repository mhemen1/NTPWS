...
<body>
	...
	if (!empty($_SESSION['news_title_1']) || !empty($_SESSION['news_title_2']) || !empty($_SESSION['news_title_3'])) {
		...
		if(isset($_SESSION['news_title_1']))		print "<button ><a href=\"index.php?menu=2&action=1\">".$_SESSION['news_title_1']."</a></button>";
		if(isset($_SESSION['news_title_2']))		print "<button ><a href=\"index.php?menu=2&action=2\">".$_SESSION['news_title_2']."</a></button>";
		if(isset($_SESSION['news_title_3']))		print "<button ><a href=\"index.php?menu=2&action=3\">".$_SESSION['news_title_3']."</a></button>";
		print "<br><button><a href=\"killsession.php\">Obriši</a></button>";
